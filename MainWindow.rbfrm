   ...
   Begin PagePanel pge_contents
      ...
      Begin Canvas can_editor_slide_editor
         ...
         Begin SEditField edt_slide_slides
            ...
            Width           =   340
         End
         Begin CheckBox chk_slide_verse_as_image
            AutoDeactivate  =   True
            Bold            =   False
            Caption         =   "song as image"
            DataField       =   ""
            DataSource      =   ""
            Enabled         =   False
            Height          =   20
...
#tag WindowCode
		...
		Sub EnableMenuItems()
		  ...
		  Else ' Sets tab
		    ...
		    If Status_InSetEditable Then
		      ...
		      chk_slide_verse_as_image.Enabled = true
		    ...
		    Else
		      ...
		      chk_slide_verse_as_image.Enabled = False
		      edt_slide_name.Text = ""
	...
	#tag Method, Flags = &h0
		Sub ActionInSetRemove()
		  ...
		  if (pge_contents.value = 4) and (lst_image_images.ListCount > 0)  then
	...
	#tag Method, Flags = &h0
		Sub ActionInSetSave()
		  ...
		  Case "song"
		    ...
		    SmartML.SetValueB xgroup, "@verse_as_image", chk_slide_verse_as_image.value
		  ...
		  Case Else
		    ...
		    For i = 0 To UBound(bodies)
		      bodies2 =  Split(bodies(i), "||")
		      For ii = 0 To UBound(bodies2)
		        xslide = xslides.AppendChild(CurrentSet.CreateElement("slide"))
		        SmartML.SetValue xslide, "body", Trim(bodies2(ii))
		      next ii
		    Next i
...
#tag Events edt_slide_slides
	...
	#tag EndEvent
#tag EndEvents
#tag Events chk_slide_verse_as_image
	#tag Event
		Sub Action()
		  Dim xnode, xgroup, songStyle As XmlNode
		  Dim songDoc as XmlDocument
