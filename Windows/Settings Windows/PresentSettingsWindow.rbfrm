   ...
   Begin TabPanel tab_present_settings
      ...
      Begin GroupBox grp_settings_misc
         ...
         Begin CheckBox chk_style_exit_prompt
            ...
            BehaviorIndex   =   58
         End
         Begin CheckBox chk_powerpoint_use_viewer
            AutoDeactivate  =   "True"
            Bold            =   "False"
            Caption         =   "Use Powerpoint Viewer"
            ControlOrder    =   60
            DataField       =   ""
            DataSource      =   ""
            Enabled         =   True
...
#tag WindowCode
	...
	#tag Event
		Sub Open()
		  ...
		  '++TH
		  if Powerpoint.ViewerAvailable=false then
		    chk_powerpoint_use_viewer.Value=false
		    chk_powerpoint_use_viewer.Enabled=false
		  else
		    chk_powerpoint_use_viewer.Value=SmartML.GetValueB(App.MyPresentSettings.DocumentElement, "powerpoint/@use_viewer",true,false)
		  end if
...
#tag Events btn_ok
	#tag Event
		Sub Action()
		  ...
		  //++TH
		  SmartML.SetValueB Settings, "powerpoint/@use_viewer",chk_powerpoint_use_viewer.Value
