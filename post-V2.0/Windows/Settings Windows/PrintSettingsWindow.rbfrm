   ...
   Begin TabPanel tab_main_tabs
      ...
      Begin Canvas can_print_fonts
         ...
         Begin Label lbl_font_copyright
            ...
            Width           =   84
         End
         Begin SEditFieldNumeric edt_font_chords_before
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_chords_after
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_capo_after
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_capo_before
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_lyrics_after
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_lyrics_before
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_sections_after
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_sections_before
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_comments_after
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SEditFieldNumeric edt_font_comments_before
            AcceptTabs      =   ""
            Alignment       =   3
            AutoDeactivate  =   True
            BackColor       =   &hFFFFFF
            ...
            Width           =   35
         End
         Begin SFontCanvas can_font_comments
            AcceptFocus     =   False
            AcceptMouseDown =   true
            AcceptTabs      =   False
            AdvancedOptions =   False
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  //
		  // A separate font for comments was added in V2.0. Prior to then,
		  //  the comments font used the copyright font. This section properly
		  //  handles the transition from older preferences files.
		  
		  tempFont = SmartML.GetValueF(PS, "comments", False)
		  If tempFont = Nil Then
		    tempFont = can_font_copyright.GetFont.Clone
		  End If
		  can_font_comments.SetFont tempFont
		  ...
		  edt_font_lyrics_before.SetValue SmartML.GetValueN(PS, "layout/lyrics/@space_before")
		  edt_font_lyrics_after.SetValue SmartML.GetValueN(PS, "layout/lyrics/@space_after")
		  edt_font_chords_before.SetValue SmartML.GetValueN(PS, "layout/chords/@space_before")
		  edt_font_chords_after.SetValue SmartML.GetValueN(PS, "layout/chords/@space_after")
		  edt_font_capo_before.SetValue SmartML.GetValueN(PS, "layout/capo/@space_before")
		  edt_font_capo_after.SetValue SmartML.GetValueN(PS, "layout/capo/@space_after")
		  edt_font_sections_before.SetValue SmartML.GetValueN(PS, "layout/sections/@space_before")
		  edt_font_sections_after.SetValue SmartML.GetValueN(PS, "layout/sections/@space_after")
		  edt_font_comments_before.SetValue SmartML.GetValueN(PS, "layout/comments/@space_before")
		  edt_font_comments_after.SetValue SmartML.GetValueN(PS, "layout/comments/@space_after")
...
#tag Events btn_ok
	#tag Event
		Sub Action()
		  ...
		  SmartML.SetValueF(PS, "comments", can_font_comments.GetFont)
		  ...
		  SmartML.SetValueN(PS, "layout/lyrics/@space_before", edt_font_lyrics_before.Value)
		  SmartML.SetValueN(PS, "layout/lyrics/@space_after", edt_font_lyrics_after.Value)
		  SmartML.SetValueN(PS, "layout/chords/@space_before", edt_font_chords_before.Value)
		  SmartML.SetValueN(PS, "layout/chords/@space_after", edt_font_chords_after.Value)
		  SmartML.SetValueN(PS, "layout/capo/@space_before", edt_font_capo_before.Value)
		  SmartML.SetValueN(PS, "layout/capo/@space_after", edt_font_capo_after.Value)
		  SmartML.SetValueN(PS, "layout/sections/@space_before", edt_font_sections_before.Value)
		  SmartML.SetValueN(PS, "layout/sections/@space_after", edt_font_sections_after.Value)
		  SmartML.SetValueN(PS, "layout/comments/@space_before", edt_font_comments_before.Value)
		  SmartML.SetValueN(PS, "layout/comments/@space_after", edt_font_comments_after.Value)
